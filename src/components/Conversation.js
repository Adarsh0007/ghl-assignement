        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="flex-1 relative">
            <Suspense fallback={<input
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 min-h-[44px]"
            />}>
              <FormField
                type="text"
                name="message"
                ...
                placeholder="Type your message..."
                className="mb-0"
                inputClassName="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 min-h-[44px]"
                onKeyPress={handleKeyPress}
              />
            </Suspense>
          </div>
