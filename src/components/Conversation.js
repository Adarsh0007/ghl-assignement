                      ...
                      <>
                        ...
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <div className="flex items-center space-x-1">
                            ...
                            <Suspense fallback={<ButtonFallback className="p-1 text-yellow-600 dark:text-yellow-400 hover:text-yellow-700 dark:hover:text-yellow-300 transition-colors duration-200" aria-label="Star message"><Star className="w-4 h-4" /></ButtonFallback>}>
                              <CustomButton
                                variant="none"
                                size="sm"
                                icon={Star}
